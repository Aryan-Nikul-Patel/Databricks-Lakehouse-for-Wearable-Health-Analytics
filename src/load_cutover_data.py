...
# MAGIC %md
# MAGIC This class sets up paths and config for loading historical data into your project. It loads the date_lookup table from a JSON file stored in the test data directory, and includes a validation step to make sure exactly 365 records were loaded. It's mainly used to backfill essential reference data before running the rest of the pipeline.
